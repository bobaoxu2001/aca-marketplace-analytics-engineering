...
def main() -> int:
    ...
    lines = [
        ...
        "| Question | Compatible projection rate | Mean Top-k | Mean group match | Mean SMAPE | Distinct SQL / 3 |",
        "| --- | ---: | ---: | ---: | ---: | ---: |",
    ]
    ...
    lines.extend([
        ...
        "the compiler depended on exact benchmark wording. After remediation, oracle-route compatible projection agreement reached 1.000; the "
        "remaining lexical-route errors combine routing and compilation failures and should be inspected individually. Because remediation used "
        "observed paraphrase failures, the improved result is diagnostic and "
