...
select
    ...
    {{ clean_numeric('"MedicalDeductibleIntegrated"') }} as medical_deductible_integrated,
    {{ clean_numeric('"MedicalDeductibleSeparate"') }} as medical_deductible_separate,
    {{ clean_numeric('"DrugDeductibleIntegrated"') }} as drug_deductible_integrated,
    {{ clean_numeric('"DrugDeductibleSeparate"') }} as drug_deductible_separate,
    {{ clean_numeric('"MedicalOutOfPocketMaximumIntegrated"') }} as medical_oop_max_integrated,
    {{ clean_numeric('"MedicalOutOfPocketMaximumSeparate"') }} as medical_oop_max_separate,
    {{ clean_numeric('"DrugOutOfPocketMaximumIntegrated"') }} as drug_oop_max_integrated,
    {{ clean_numeric('"DrugOutOfPocketMaximumSeparate"') }} as drug_oop_max_separate,
