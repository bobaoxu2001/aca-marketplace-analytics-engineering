...
Expected validated project size: 20 models plus 88 data tests, 108 dbt build
steps total. Raw files and the DuckDB database are intentionally not committed.
